...
namespace FoodToGo_API.Migrations
{
    ...
    [Migration("20230622013529_renameTrigger")]
    partial class renameTrigger
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodToGo_API.Models.DbEntities.MenuItemRating", b =>
                {
                    ...
                    b.ToTable("MenuItemRatings", t =>
                        {
                            t.HasTrigger("updateMenuItemRating");
                        });
                });
            ...
            modelBuilder.Entity("FoodToGo_API.Models.DbEntities.MerchantRating", b =>
                {
                    ...
                    b.ToTable("MerchantRatings", t =>
                        {
                            t.HasTrigger("updateMerchantRating");
                        });
                });
